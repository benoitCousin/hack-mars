...
<div class="main">
    ...
    <img data-bs-toggle="modal" data-bs-target="#nomLieu" class="finger" src="fingerClick.gif" style="left: 1500px; top: 956px">


    
    <div class="modal fade" id="nomLieu" tabindex="-1" aria-labelledby="nomLieu" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Margaritifer terra</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="imgHotspot"> <img class="img-fluid"src="./media/mars1.jpg" alt=""> </div>
                </div>
    ...
    <img data-bs-toggle="modal" data-bs-target="#olympus" class="finger" src="fingerClick.gif" style="left: 450px; top: 656px">



    <div class="modal fade" id="olympus" tabindex="-1" aria-labelledby="nomLieu" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Olympus Mons</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="imgHotspot"> <img class="img-fluid"src="./media/mont-olympe.jpg" alt=""> </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
